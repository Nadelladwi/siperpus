...
<div class="card">
 ...
 <div class="card-body">
 <a href="form-pinjam.php" class="btn btn-success"> <i class="fa fa-plus"></i> Buat Baru </a> 
...
<?php
 ...
 <td>
 <a href="detail.php?id_pinjam=<?= $p['id_pinjam'] ?>&nama_petugas=<?= $p['nama_petugas'] ?>"  class="badge badge-success">Detail</a> 
